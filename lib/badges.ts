...
export const BADGES: BadgeDef[] = [
  // Handels-Badges (Medaillen bleiben Emoji)
  ...
  { id: 'trades_2500', label: '2.500 Trades',  description: '2.500 Trades platziert', icon: 'diamond', category: 'trades' },
  // Treffsicherheits-Badges
  { id: 'wins_10',   label: '10 korrekte Prognosen',   description: '10 Märkte korrekt vorhergesagt',   icon: 'target', category: 'wins' },
  { id: 'wins_50',   label: '50 korrekte Prognosen',   description: '50 Märkte korrekt vorhergesagt',   icon: 'target', category: 'wins' },
  { id: 'wins_100',  label: '100 korrekte Prognosen',  description: '100 Märkte korrekt vorhergesagt',  icon: 'target', category: 'wins' },
  { id: 'wins_500',  label: '500 korrekte Prognosen',  description: '500 Märkte korrekt vorhergesagt',  icon: 'target', category: 'wins' },
  { id: 'wins_750',  label: '750 korrekte Prognosen',  description: '750 Märkte korrekt vorhergesagt',  icon: 'target', category: 'wins' },
  { id: 'wins_1000', label: '1.000 korrekte Prognosen', description: '1.000 Märkte korrekt vorhergesagt', icon: 'target', category: 'wins' },
  // Streak-Badges
  { id: 'streak_7',   label: '7-Tage-Streak',   description: '7 Tage Login-Streak',   icon: 'flame', category: 'streak' },
  { id: 'streak_30',  label: '30-Tage-Streak',  description: '30 Tage Login-Streak',  icon: 'flame', category: 'streak' },
  { id: 'streak_100', label: '100-Tage-Streak', description: '100 Tage Login-Streak', icon: 'flame', category: 'streak' },
]
